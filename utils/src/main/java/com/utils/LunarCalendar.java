...
import com.utils.language.LangManager;
 ...
 * @author joel
 * 
 * https://github.com/heqiao2010/LunarCalendar
 *
 */
public class LunarCalendar implements Serializable {
	 ...
	 * 农历月份名
	 */
	private static final String[] LunarMonthName = { LangManager.text("正"), LangManager.text("二"),
			LangManager.text("三"), LangManager.text("四"), LangManager.text("五"), LangManager.text("六"),
			LangManager.text("七"), LangManager.text("八"), LangManager.text("九"), LangManager.text("十"),
			LangManager.text("十一"), LangManager.text("十二") };
	 ...
	 * 农历季节名
	 */
	private static final String[] LunarSeasonName = { LangManager.text("春"), LangManager.text("夏"),
			LangManager.text("秋"), LangManager.text("冬") };
	 ...
	 * @return
	 */
	public String getSeasonName(int lunarMonth) {
		return LunarSeasonName[(lunarMonth - 1) / 3];
	}
